-- Redundant with 081500 after recursion fix; kept for migration order on existing DBs.
-- Applies same current_user_has_company_leave_access() pattern if 081500 was an older copy.
